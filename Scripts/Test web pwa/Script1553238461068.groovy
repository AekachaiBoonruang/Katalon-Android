...
WebUI.click(findTestObject('Mobile element/pwa.submit'))

WebUI.delay(2)

WebUI.waitForElementPresent(findTestObject('Mobile element/android.verify'), 0)

WebUI.verifyTextPresent('คุณลืมรหัสผ่านของคุณใช่ไหม', false)
